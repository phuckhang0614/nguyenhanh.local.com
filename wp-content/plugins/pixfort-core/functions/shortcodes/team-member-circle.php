		...
		$output .= '<div class="'. esc_attr( $css_class ) .' '.$position.' '.$anim_class.'" style="position:relative" data-anim-type="'.$animation.'" data-anim-delay="'.$delay.'">';
            ...
            $output .= '</div>';
                $output .= '<div class="'.$position.'">';
                    $output .= '<'.$name_tag.' class="pix-member-name card-title mb-3 '.$name_classes.' '.$anim_class.'" '.$name_style.' data-anim-type="'.$animation.'" data-anim-delay="'.$delay.'">'.$name.'</'.$name_tag.'>';
					$delay+=100;
                    $output .= '<'.$title_tag.' class="pix-member-title mb-3 '.$title_classes.' '.$anim_class.'" '.$title_style.' data-anim-type="'.$animation.'" data-anim-delay="'.$delay.'"><strong>'.$title.'</strong></'.$title_tag.'>';
					$delay+=100;
