            ...
            <div class="dup-pro-recovery-active-link-header" >
                ...
                <div class="main-title" >
                    ...
                    <i
                        ...
                        data-tooltip="<?php DUP_PRO_U::_e('A package is considered &quot;out of date&quot; if it is older than 12 hours.  If this site\'s data has changed in the last 12 hours then you might want to consider building a newer recovery point.');?>"
                    ></i>
                </div>
                <div class="main-subtitle margin-bottom-1" >
