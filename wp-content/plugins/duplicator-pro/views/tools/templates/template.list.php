        ...
        <tbody>
            ...
            foreach ($package_templates as $package_template) :
                ...
                <tr class="package-row <?php echo ($i % 2) ? 'alternate' : ''; ?>">
                    ...
                    <td class="col-name" >
                        <a href="javascript:void(0);" onclick="DupPro.Template.Edit(<?php echo intval($package_template->id); ?>);" class="name" data-template-id="<?php echo intval($package_template->id); ?>"><?php echo esc_html($package_template->name); ?></a>
                        <div class="sub-menu">
                            <a class="dup-edit-template-btn" href="javascript:void(0);"onclick="DupPro.Template.Edit(<?php echo intval($package_template->id); ?>);" ><?php DUP_PRO_U::esc_html_e('Edit'); ?></a> |
                            <a class="dup-copy-template-btn" href="javascript:void(0);"onclick="DupPro.Template.Copy(<?php echo intval($package_template->id); ?>);" ><?php DUP_PRO_U::esc_html_e('Copy'); ?></a>
                            <?php if ($package_template->is_default == false) : ?>
                                | <a class="dup-delete-template-btn" href="javascript:void(0);" onclick="DupPro.Template.Delete(<?php echo esc_js("$package_template->id, $schedule_count"); ?>);"><?php DUP_PRO_U::esc_html_e('Delete'); ?></a>
                            <?php endif; ?>
                        </div>                        
                    </td>
