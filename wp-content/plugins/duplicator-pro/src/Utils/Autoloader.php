...
final class Autoloader
{
    ...
    {
        self::loadComposerDependencies();
        spl_autoload_register(array(__CLASS__, 'load'));
    }

    /**
     * Includes composer dependencies into the project
     *
     * @return void
     */
    public static function loadComposerDependencies()
    {
        require DUPLICATOR____PATH . '/vendor/autoload.php';
    }
    ...
    protected static function externalLibs($className)
    {
        switch (strtolower(ltrim($className, '\\'))) {
            case 'requests':
                ...
                require(DUPLICATOR____PATH . '/vendor/other_libs/requests/library/Requests.php');
    ...
    protected static function customLegacyMapping()
    {
        return array(
            ...
            'pcrypt'                          => DUPLICATOR____PATH . '/vendor/other_libs/pcrypt/class.pcrypt.php'
        );
    }
