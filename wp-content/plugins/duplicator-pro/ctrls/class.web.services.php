...
class DUP_PRO_Web_Services extends AbstractAjaxService
{
    ...
    function duplicator_pro_sftp_send_file_test()
    {
        ...
        try {
            ...
            if ($sftp->put($storage_folder . $basename, $source_filepath, $sFtpAdapter->source_local_files | $sFtpAdapter->sftp_resume)) {
    ...
    function duplicator_pro_s3_send_file_test()
    {
        ...
        try {
            ...
            if (DUP_PRO_S3_U::upload_file($s3_client, $bucket, $source_filepath, $storage_folder, $storage_class, $ACL_full_control, '', $statusMsgsObj)) {
                $json['success'] = true;
                $json['message'] = __('Successfully stored and retrieved file', 'duplicator-pro');
                $statusMsgsObj->addMessage(__('Successfully stored and retrieved file', 'duplicator-pro'));
                ...
                $statusMsgsObj->addMessage(__('Test failed. Check configuration.', 'duplicator-pro'));
